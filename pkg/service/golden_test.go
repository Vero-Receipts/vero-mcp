	...
	tests := []struct {
	...
	}{
		{
			...
			want: domain.OCRResult{
				...
				MerchantAddress: "Parc Detroit, 800 Woodward Ave, Detroit, MI 48226",
...
Thank you for your purchase!`,
		...
		},
		{
			...
			want: domain.OCRResult{
				...
				Tax:           floatPtr(40.24),
				Tip:           floatPtr(0),
				Total:         floatPtr(371.40),
				Currency:      "USD",
				PaymentMethod: "Apple Pay",
				LineItems: []domain.LineItem{
					{Description: "New ticket (0012342449376)", Quantity: 1, UnitPrice: 331.16, Price: 331.16},
				},
			},
		},
	}
